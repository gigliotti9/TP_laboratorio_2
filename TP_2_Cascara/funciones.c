...
void funcionGrafico(EPersona lista[],int tam)
{
    ...
    int j;
    int max;
    int menores=0,medio=0,mayores=0;
    int flag=0;
    ...
    for(i=0; i<tam; i++)
    {
        ...
        else if(lista[i].edad>35 && lista[i].edad<149)
        {
            mayores++;
        }
    }
    if(menores >= medio && menores >= mayores)
    {
    ...
    else
    {
        ...
        if(medio >= menores && medio >= mayores)
        {
            max = medio;
        }
        else
